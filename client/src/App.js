...
let theRecipeId = this.state.RecipeID;
++theRecipeId;
...
Axios.post("/api/putData", 
{
  ...
  recipeUser: this.state.RecipeUserNamer,
 recipeCategory: this.state.RecipeCategory,
  recipeName: this.state.RecipeName,
  recipeInstructions: this.state.RecipeDirections,
   recipePicture: this.state.RecipePic
...
fetchNewRecipes()   {
  Axios.get("/api/viewAllRecipes")
  .then(this.setState({Response: this.state.Response}));
  ...
  listItems() {
   ...
   render () {
    return (
      ...
      <tr>
        <td><button onClick={this.fetchNewRecipes.bind(this)}>VIEW LATEST</button></td>
        </tr>          
        </table>
